...
There are many different ways in which you can contribute. One of the easiest ways is to use our software and provide us with your feedback through the right channel. You can also help us improve the open-source projects by submitting pull requests with code and documentation changes.

## Where to get support

Please note that **level of provided support is always determined by the [LICENSE](LICENSE.md)** of a given open-source project. Also, always make sure you use the **[latest version](../../releases)** of any given open-source project. We don't provide support for older versions. We try to take the same approach in all our repositories.
...
Security issues and bugs should be reported privately, via email, to Kontent.ai Developer Relations Team at devrel@kontent.ai. You should receive a response within 24 hours. If you don't get an answer, send us a follow up email to ensure we received your original message.
