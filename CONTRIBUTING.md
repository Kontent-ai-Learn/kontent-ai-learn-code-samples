...
Unlike the majority of our OS repositories which use [feature branch workflow](https://www.atlassian.com/git/tutorials/comparing-workflows/feature-branch-workflow), in [KenticoDocs repositories](https://github.com/KenticoDocs), we prefer [gitflow workflow](https://www.atlassian.com/git/tutorials/comparing-workflows/gitflow-workflow).
