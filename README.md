...
Check out our [guidelines on writing code samples and versioning them](https://kontent-ai.atlassian.net/wiki/spaces/CE/pages/681246787/Code+samples).
...
If your code changes are merged to the main branch, the new code is automatically added to the Kontent.ai Learn project.
